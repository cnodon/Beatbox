...
- 耳机监听只在 KTV 麦克风会话中接通，默认关闭并提供独立音量；界面必须警告扬声器回声和啸叫风险。
- 可提供非破坏性的本地立体声中置人声抵消，并将衍生伴奏与原歌曲分开保存；必须说明它不是 AI 分轨及其对中央乐器的影响。
- 首版不做 AI 分轨、评分、自动混音或联网获取歌词；界面必须明确标注原唱音频与干声录制边界。
